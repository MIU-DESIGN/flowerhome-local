	...
	<section class="article-section01 bg_wh bg_wh04 cf" itemprop="articleBody">
		...
		<div class="container600">
			<div class="search-section01 search-section_date fadein btt">
				...
				<?php if (have_rows('datelist')) : ?>

					<ul class="list_date">

						<?php while (have_rows('datelist')) : the_row(); ?>

							<li>

								<a href="#<?php the_sub_field('date'); ?>">
									<?php
		...
		<div class="container1040">
			...
			<?php if (have_rows('datelist')) : ?>
				...
				<?php while (have_rows('datelist')) : the_row(); ?>
					...
					<h2 id="<?php the_sub_field('date'); ?>" class="heading_brd-b01 fadein btt">
						<?php
						$date = get_sub_field('date');
						$term_id = $date;
						$term = get_term($term_id);
