...
- moving flowerhome ahoy function to main functions file
...
- removed "Powered by Wordpress & flowerhome" from footer, because let's face it: we all delete this anyway.
...
- removed default "flowerhome" text in footer if you don't have a menu
...
- added flowerhome body class depending on what browser
...
- added post formats to flowerhome.php core
...
- fixed error in flowerhome.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the flowerhome file so it's easier to see what's being
	called.
